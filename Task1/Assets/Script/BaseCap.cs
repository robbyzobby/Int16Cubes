...
public class BaseCap : MonoBehaviour {
    ...
    void Awake()
    {
        CountX = GameObject.FindGameObjectWithTag("Spawn").GetComponent<CapSpawner>().CountX;
        CountY = GameObject.FindGameObjectWithTag("Spawn").GetComponent<CapSpawner>().CountY;
